...
class CephSecretsClient:
    ...
    @staticmethod
    def _scope_str(scope: Union[SecretScope, str, Any]) -> str:
    ...
    def secret_get_data(
        self,
        namespace: str,
        scope: Union[SecretScope, str, Any],
        target: str,
        name: str,
    ) -> Dict[str, Any]:
        return self._remote(
    ...
    def secret_rm(self, namespace: str, scope: Union[SecretScope, str, Any], target: str, name: str) -> bool:
        return bool(
            self._remote(
                "secret_rm",
                namespace=namespace,
